import cv2
import os
from create_csv import data_frame


if __name__ == "__main__": #so it only runs this code when the file is ran not when we import one of the variables to the recognizer file
    ...
    #add name to student_list and to dataframe of csv
